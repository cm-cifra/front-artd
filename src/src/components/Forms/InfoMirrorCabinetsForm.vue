...
export default{
    ...
    methods: {
        findData(){
            ...
            axios.get(process.env.VUE_APP_BASE_URL + '/info_mirror_cabinets/find_by_product/' + this.data_info.product_id)
            .then((res)=>{
        ...
        editForm(){
            ...
            axios.post(process.env.VUE_APP_BASE_URL + '/info_mirror_cabinets/edit', this.data_info)
                .then((res)=>{
