...
export default{
    ...
    methods: {
        findData(){
            ...
            axios.get(process.env.VUE_APP_BASE_URL + '/info_shower_systems/find_by_product/' + this.data_info.product_id)
            .then((res)=>{
        ...
        editForm(){
            ...
            axios.post(process.env.VUE_APP_BASE_URL + '/info_shower_systems/edit', this.data_info)
                .then((res)=>{
