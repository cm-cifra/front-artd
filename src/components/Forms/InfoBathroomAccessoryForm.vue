    ...
    <div class="flex-1 flex flex-col bg-white p-8 space-y-4">
        ...
        <div class="flex flex-col sm:flex-row gap-4">
            <div class="flex-auto flex flex-col">
                ...
                <input v-model="data_info.product_equipment" type="text" class="rounded-lg border-gray-400 focus:outline-none focus:ring-0 focus:border-gray-200 font-bold text-sm w-full p-4">
            </div>
        </div>
...
export default{
    ...
    methods: {
        findData(){
            ...
            axios.get(process.env.VUE_APP_BASE_URL + '/info_bathroom_accessories/find_by_product/' + this.data_info.product_id)
            .then((res)=>{
                ...
                if(res.status == 200){
                    ...
                    this.data_info.product_equipment = res.data.product_equipment;
        ...
        editForm(){
            ...
            axios.post(process.env.VUE_APP_BASE_URL + '/info_bathroom_accessories/edit', this.data_info)
                .then((res)=>{
