...
const routes = [
...

  {
    ...
    children: [
      ...
      },
      {
      ...
      },
       {
        ...
        alias: '/order-details/:id',
        component: () => import('../views/admin/CheckoutInfo.vue'),
        meta: { title: 'Assign User Menu', ParentName: 'Home' }
      },
    ]
  }, {
    path: '/check',
    alias: '/check',
    component: () => import('../views/admin/checkoutDetail.vue'),
    props: (route: { query: { user_id: any; date: any; }; }) => ({ user_id: route.query.user_id, date: route.query.date }),
  },
]
